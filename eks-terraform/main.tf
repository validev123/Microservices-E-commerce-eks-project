...
resource "aws_iam_policy" "autoscaler" {
  name = "vali-eks-autoscaler-policy1"
  policy = jsonencode({
    Version = "2012-10-17",
    Statement = [{
      Action = [
